...
Пусть \mathbf{V}-линейное пространство, $\mathbf{L}\subset \mathbf{V}$- его подпространство. Тогда \mathbf{V} распадается на непересекающиеся линейный афинные многообразия с направляющим подпространством $\mathbf{L}$.
\end{block}
